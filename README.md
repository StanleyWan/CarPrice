...
# Overview
This project explores a used car dataset: [vehicles.csv](https://github.com/StanleyWan/CarPrice/blob/main/data/vehicles.csv) of 426,000 used cars (sampled from the original Kaggle dataset of 3 million entries) with the goal of identifying the key factors that influence used car prices. The analysis follows the CRISP-DM (Cross Industry Standard Process for Data Mining) methodology to ensure a structured and repeatable approach. 
<p align="center">
...
Here is [the link of the Jupyter Notebook: Car_Price.ipynb](https://github.com/StanleyWan/CarPrice/blob/main/Car_Price.ipynb) with visualizations and probability distributions. It is developed under Google's Colab.
...
<p align="center">
  <img src="images/[missingness_topN.png](https://github.com/StanleyWan/CarPrice/blob/main/images/missingness_topN.png)" width="800"/><br>
...
| js_type        | 0.341770                     |
| drive_ord      | 0.182561                     |
| cylinders_num  | 0.124796                     |
| year           | 0.074758                     |
| odometer_10k   | -0.038593                    |

------
### [Huber] Coefficients on Standardized Scale (target = log-price)

| Feature        | Coefficient (Standardized) |
|----------------|-----------------------------|
| year           | 0.409527                   |
| odometer_10k   | -0.237094                  |
| cylinders_num  | 0.150925                   |
| js_fuel        | 0.141420                   |
| drive_ord      | 0.137607                   |
| js_type        | 0.107624                   |
